...
public class PinpointDrive extends MecanumDrive {
    public static class Params {
        ...
        public double xOffset = Constants.xForwardEncoderOffsetInches;
        public double yOffset = Constants.yStrafeEncoderOffsetInches;
         ...
         */
        public double encoderResolution = Constants.encoderResolution;
